  ...
  return (
    <section className="rounded-2xl bg-[#07152f] p-5 text-white sm:p-7">
      ...
      <div className="mt-7 grid gap-4 sm:grid-cols-2">
        ...
        <label className="flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-dashed border-white/20 p-4 text-xs font-bold"><Upload className="h-4 w-4 text-[#62b8ff]" />Enviar foto da equipe<input type="file" accept="image/jpeg,image/png,image/webp,image/avif" className="sr-only" onChange={(event) => event.target.files?.[0] && uploadSetting(event.target.files[0], "team_image_url")} /></label>
